...
<h2 align="center"><s:text name="page.heading.createcase"/></h2>
...
<s:form name="caseform" action="savecase" method="post"  theme="simple" validate="true" >
  	...
  	<div class="row" style='padding-top: 10px'>
		...
		<div class="col-sm-4 col-xs-12">
			<s:select id="propertyId" cssClass="form-control" name="attorneyVo.propertyId" list="propList" listKey="propertyId" listValue="propertyName" emptyOption="false"  theme="xhtml"/>
		</div>
	...
	<div class="row" style='padding-top: 20px'>
		...
		<div class="col-sm-4 col-xs-12"><s:textfield id="caseName" name="attorneyVo.caseName"  cssClass="form-control" maxlength="50" /></div>
		<div class="col-sm-4 col-xs-12">&nbsp;</div>
	</div>
	...
	<div class="row" style='padding-top: 20px'>
		...
		<div class="col-sm-4 col-xs-12">
              <s:textfield id="endDate" name="attorneyVo.closeDate" cssClass="form-control" cssStyle="width:92%;display:inline" maxlength="10" onchange="checkDate(this)"/>
	...
	<div class="row" style='padding-top: 20px'>
		...
		<div class="col-sm-4 col-xs-12"><s:select id="status" name="attorneyVo.status"  cssClass="form-control" list="#{'Filed':'Filed','Responded':'Responded'}"  /></div>
		<div class="col-sm-4 col-xs-12">&nbsp;</div>
	</div>
 	...
 	<div class="row" style='padding-top: 20px'>
		<div class="col-sm-4 col-xs-12">&nbsp;</div>
		<div class="col-sm-4 col-xs-12">
	    <s:submit type="button" value="Create Case" cssClass="submit"></s:submit>
