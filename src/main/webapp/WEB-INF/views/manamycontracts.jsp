...
<h2 align="center"> <s:text name="page.heading.concontracts"/></h2>
<head>
...
<s:form name="payrentform" method="post" theme="simple">
   ...
   <div class="row" style='padding-bottom: 20px'>
	...
	<table class="table table-bordered">
	  <thead class="table-row">
	     <tr>
			<th class="table-cell" colspan="8">Manage Contracts</th>
		</tr>
		</thead>
	   <thead class="table-row">
	   <tr>
		...
		<s:iterator value="contractorList" var="contractVo">
	        <tr class="table-row">
				...
				<td class="table-cell"> <a href="createprogress?contractid=<s:property value="contractId"/>"> Create</a></td>
		    </tr>
		    </s:iterator>
	   </table>
	</div>
